...
//    };
    ...
    final Level[] LEVEL = {
            new Level(500, 2000, 1000, data),
            new Level(250, 1500, 2000, data),
            new Level(120, 1000, 3000, data),
            new Level(100, 500, 4000, data),
    };
    ...
    public synchronized void levelUp() {
        ...
        lbLevel.setText("Levle:"+curLevel);
        words.clear();
        screen.clear();
        showLevel(curLevel);
        speed = level.speed;
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            for(int i=0; i < words.size() ; i++) {
                ...
                if(input.equals(tmp.word)) {
                    ...
                    if(curLevel!=MAX_LEVEL && levelUpCheck()) { //게속해서 LEVEL을 체크해준다.!
                        levelUp();
                    } else {
                        if(tmp.isVirus) {
